...
cost_per_day = 35  //Full day button is clicked by default
...
calculated_cost = document.getElementById("calculated-cost")
full_day_button = document.getElementById('full')
half_day_button = document.getElementById('half')
